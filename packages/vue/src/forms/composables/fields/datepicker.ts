...
export function useDatepickerField<ModelValueType = any>(props: DefaultProps & { field: NormalizedDatepickerField }) {
  ...
  const { modelValue, vmodel } = useModelValue<ModelValueType>(props)
