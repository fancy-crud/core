...
import type { BaseRawField, NormalizedField, NormalizedFields, ObjectWithRawFields } from '@packages/core/forms/axioma'
...
export class NormalizeFormFieldsCommand<T extends NormalizeFormFieldsCommandInputType> implements BaseCommand {
  public readonly meta = meta(NormalizeFormFieldsHandler)
...
**/
class NormalizeFormFieldsHandler {
